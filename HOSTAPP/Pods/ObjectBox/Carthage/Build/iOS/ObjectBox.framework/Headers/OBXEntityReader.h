...
- (uint8_t)uint8AtPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(uint8(at:));
- (nullable NSNumber *)optionalUInt8AtPropertyOffset:(uint16_t)propertyOffset NS_REFINED_FOR_SWIFT;
- (uint16_t)uint16AtPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(uint16(at:));
- (nullable NSNumber *)optionalUInt16AtPropertyOffset:(uint16_t)propertyOffset NS_REFINED_FOR_SWIFT;
- (uint32_t)uint32AtPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(uint32(at:));
- (nullable NSNumber *)optionalUInt32AtPropertyOffset:(uint16_t)propertyOffset NS_REFINED_FOR_SWIFT;
- (uint64_t)uint64AtPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(uint64(at:));
- (nullable NSNumber *)optionalUInt64AtPropertyOffset:(uint16_t)propertyOffset NS_REFINED_FOR_SWIFT;
