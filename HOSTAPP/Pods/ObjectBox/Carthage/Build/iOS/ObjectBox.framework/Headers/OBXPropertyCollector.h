...
- (void)collectUInt8:(uint8_t)value atPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(collect(_:at:));
- (void)collectUInt16:(uint16_t)value atPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(collect(_:at:));
- (void)collectUInt32:(uint32_t)value atPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(collect(_:at:));
- (void)collectUInt64:(uint64_t)value atPropertyOffset:(uint16_t)propertyOffset NS_SWIFT_NAME(collect(_:at:));
